...
class StoreDetails extends Component {
    ...
    render() {
        return (
            this.state.validSelection && <div className=' text-gray-700'>
                ...
                {(this.state.storeId === this.state.storePreference) && <div className='flex justify-end font-light text-md sm:text-lg'>
                    <svg className='w-6 h-6 fill-current text-yellow-400' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
